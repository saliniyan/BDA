...
log_df = spark.read.csv('/home/saliniyan/Documents/BDA/logs_df(ml).csv', header=True, inferSchema=True)
...
for name, clf in classifiers.items():
    ...
    model_path = f"/home/saliniyan/Documents/BDA/hosting/{name.replace(' ', '_')}_model"
    model.save(model_path)
    print(f"{name} model saved at {model_path}")
    
    # Save the scaler model
    scaler_path = f"/home/saliniyan/Documents/BDA/hosting/{name.replace(' ', '_')}_scaler"
